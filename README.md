# Create a full MATE Desktop using WSL
...
> ⚠️ **WARNING**  
> This procedure was originally designed for **Windows 11 22H2**(and likely early **23H2** builds). Starting with **Windows 11 25H2**, additional compatibility steps are required and are documented as well.
